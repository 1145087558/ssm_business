...
<body>
	...
	<div class="content">
		<div class="content-left">
			<div class="picture">
				<div id="myCarousel" class="carousel slide">
					...
					<div class="carousel-inner">
						...
						<div class="item">
							<img src="image/c1.jpg" alt="Second slide">
						</div>
						<div class="item">
							<img src="image/c1.jpg" alt="Third slide">
						</div>
					</div>
					<!-- 轮播（Carousel）导航 -->
			...
			<div class="recommand">
				<div class="recommand-title">中国书法作品欣赏 书法作品赏析</div>
				<p style="text-align: center; font-size: 20px;">中国书法作品欣赏 书法作品赏析</p>
				<hr>
				<c:forEach items="${calList}" var="calligraphy">
					<c:if test="${calligraphy.art_status==0}">
						<a href="art_content.form?id=${calligraphy.id}"><p
								style="font-size: 16px;">
								${calligraphy.title}<span>${calligraphy.author}</span>
							</p> </a>
						<hr>
					</c:if>
				</c:forEach>
			...
			<div class="jc-art">
				...
				<c:forEach items="${calList}" var="calligraphy">
					<c:if test="${calligraphy.art_status==1}">
						<a href="art_content.form?id=${calligraphy.id}"><p
								style="font-size: 16px;">${calligraphy.title}</p> </a>
