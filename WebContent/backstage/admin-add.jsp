...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" action="addUser.form">
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<textarea name="synopsis" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="$.Huitextarealength(this,100)"></textarea>
