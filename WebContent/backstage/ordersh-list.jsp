		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除</a></span> <span class="r">共有数据：<strong>${fn:length(orderList)}</strong>
				条
			</span>
		</div>
		<div class="mt-20">
					...
					<c:forEach items="${orderList}" var="order">
						<tr class="text-c">
							...
							<td class="td-status"><span
								class="label label-danger radius">申请退款</span></td>
							<td class="td-manage"><a style="text-decoration: none"
								href="javascript:;" onClick="member_huanyuan(this,'${order.order_number}')"
								title="通过"><i class="Hui-iconfont">&#xe66b;</i></a> <a
