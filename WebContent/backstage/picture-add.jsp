...
<body>
	<div class="page-container">
		<form class="form form-horizontal" id="form-article-add"
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>作品题材：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<span class="select-box"> <select name="opus_tipic"
						class="select" id="opus_tipic">
							<c:forEach items="${tipicList}" var="tipics">
								<option value="${tipics.tipic}">${tipics.tipic}</option>
							</c:forEach>
					</select>
					</span>
				</div>
		...
		function article_save_submit() {
			if (isFile == 1) {
				uploader.on('uploadBeforeSend', function(object, data, header) {
					...
					data.opus_tipic = $("#opus_tipic").find("option:selected")
							.text();
