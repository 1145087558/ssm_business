	...
	<div class="page-container">
		<div class="cl pd-5 bg-1 bk-gray">
			<span class="l"> <a href="javascript:;" onclick="datadel()"
				...
				onclick="admin_role_add('添加用户','member-add.jsp','','510')"><i
					class="Hui-iconfont">&#xe600;</i> 添加用户</a>
			</span> <span class="r">共有数据：<strong>${fn:length(users)}</strong> 条
			</span>
		</div>
					...
					<tr class="text-c">
						...
						<c:if test="${user.status==1}">
							...
							<td class="f-14"><a style="text-decoration: none"
								...
								title="管理员"><i class="Hui-iconfont">&#xe631;</i></a></td>
						</c:if>
						<c:if test="${user.status==0}">
							...
							<td class="f-14"><a style="text-decoration: none"
								...
								title="超级管理员"><i class="Hui-iconfont">&#xe631;</i></a></td>
						</c:if>
					</tr>
				</c:forEach>
			</tbody>
