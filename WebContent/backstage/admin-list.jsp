	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				onclick="admin_add('添加管理员','admin-add.jsp','800','500')"
				class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>
					添加管理员</a></span> <span class="r">共有数据：<strong>${fn:length(users)}</strong>
				条
			</span>
		</div>
				...
				<c:forEach items="${users}" var="user">
					<tr class="text-c">
						...
						<td class="td-manage"><a style="text-decoration: none"
							onClick="admin_stop(this,'${user.id}')" href="javascript:;"
							title="停用"><i class="Hui-iconfont">&#xe631;</i></a> <a title="删除"
							href="javascript:;" onclick="admin_del(this,'${user.id}')"
