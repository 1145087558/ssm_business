	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				onclick="tipic_add('添加题材','tipic-add.jsp','400','300')"
				class="btn btn-primary radius"><i class="icon-plus"></i> 添加题材</a></span> <span
				class="r">共有数据：<strong>${fn:length(tipicList)}</strong> 条
			</span>
		</div>
		<div class="mt-20">
					...
					<c:forEach items="${tipicList}" var="tipics">
						<tr class="text-c">
							...
							<td class="td-manage"><a title="删除" href="javascript:;"
								onclick="picture_del(this,'${tipics.id}')" class="ml-5"
