...
<body>
		...
		<div class="container-fluid cl">
			...
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover"><a href="#"
					class="dropDown_A">${sessionScope.user.name} <i
						class="Hui-iconfont">&#xe6d5;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="getOpusAll.form" data-title="作品管理"
						href="javascript:void(0)">作品管理</a></li>
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					...
					<c:if test="${sessionScope.user.status==1}">
						<li><a data-href="getDiscussmsgAll.form" data-title="评论列表"
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="getUserList.form" data-title="会员列表"
		...
		<c:if test="${sessionScope.user.status==1}">
			<dl id="menu-admin">
				...
				<dd>
					<ul>
						<li><a data-href="getUserAllList.form" data-title="角色管理"
							href="javascript:void(0)">角色管理</a></li>
						<!-- <li><a data-href="admin-permission.html" data-title="权限管理" href="javascript:void(0)">权限管理</a></li> -->
						<li><a data-href="getAdminUser.form" data-title="管理员列表"
